...
class TaxCalculationTest(TestCase):
    def test_qw_ord_0(self):
        # Prepare test data
        data = {
            'tax_filing_status': 'qw',
            'tax_tax_year': '2022',
